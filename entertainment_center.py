...
Parameters of the movie class:
  ...
  Parental Rating
'''
# creating Movie object for The Hobbit: The Battle of the Five Armies.
...
# creating Movie object for Amadeus.
amadeus = media.Movie(
    "Amadeus",
    "(1984)",
...
# creating Movie object for Django Unchained.
...
# creating Movie object for War of Arrows.
war_of_arrows = media.Movie(
    "War of Arrows",
    "(2011)",
...
# creating Movie object for The Beat That My Heart Skipped.
beat_that_my_heart_skipped = media.Movie(
...
# creating Movie object for American Psycho.
...
# creating Movie object for The Big Lebowski.
...
# creating Movie object for Ferris Bueller's Day Off.
...
# creating Movie object for The Good, The Bad, and The Ugly.
...
# creating Movie object for Snatch
snatch = media.Movie(
    "Snatch",
    "(2000)",
...
# creating Movie object for Kiss Kiss Bang Bang.
...
# creating Movie object for Old Boy.
old_boy = media.Movie(
    "Old Boy",
    "(2000)",
...
# creating Movie object for Perfume.
perfume = media.Movie(
